...
latex_documents = [
    ('index', 'django-dbbackup.tex', 'django-dbbackup Documentation',
     'Michael Shepanski', 'manual'),
]
...
man_pages = [
    ('index', 'django-dbbackup', 'django-dbbackup Documentation',
     ['Michael Shepanski'], 1)
]
...
texinfo_documents = [
    ('index', 'django-dbbackup', 'django-dbbackup Documentation',
     'Michael Shepanski', 'django-dbbackup', 'One line description of project.',
     'Miscellaneous'),
]
